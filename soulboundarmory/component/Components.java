...
public final class Components {
	...
	public static final EntityComponentKey<MasterArmorComponent> armor = ComponentRegistry.entity(PlayerEntity.class, "armor", player -> !(player.world.isClient && player instanceof OtherClientPlayerEntity), MasterArmorComponent::new);
	...
	private static final List<EntityComponentKey<? extends MasterComponent<?>>> soulboundComponents = List.of(armor, tool, weapon);
