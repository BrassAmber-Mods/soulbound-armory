...
abstract class LightningEntityMixin implements LightningEntityAccess {
	...
	@Override public abstract int life();

	@Accessor("ambientTick")
	@Override public abstract void life(int flashes);

	@Accessor("remainingActions")
	@Override public abstract int flashes();

	@Accessor("remainingActions")
	@Override public abstract void flashes(int flashes);
}
